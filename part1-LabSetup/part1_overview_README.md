...
The idea is to leave Kali Linux out as the attacker while using Active Directory to centralize and control other machines. In this scenerio, I assumed that the attacker got inside the internal network through a VPN.
